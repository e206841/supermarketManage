...
import cn.stylefeng.guns.config.interceptor.SsoClientInterceptor;
...
@ComponentScan(basePackages = {
        ...
        "cn.stylefeng.guns.base.auth.*",
        "cn.stylefeng.guns.sys.modular.system.service.*"
})
@Import({RestTemplate.class, WebSecurityConfig.class,SsoProperties.class})
@Configuration
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry
                .addInterceptor(new SsoClientInterceptor(ssoProperties, remoteService(), clientCache, authApi))
                .addPathPatterns("/**")
                .excludePathPatterns("/gunsApi/**", "/static/**", "/assets/**","/pages/**","/global/sessionError", "/global/sessionError", "/kaptcha","/logout");
    }
