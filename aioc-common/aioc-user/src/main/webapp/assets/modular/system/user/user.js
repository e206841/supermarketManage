layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax', 'func', 'tree', 'util'], function () {
    ...
    MgrUser.initColumn = function () {
        return [[
            ...
            {field: 'birthday', align: "center", sort: true, title: '生日'},
            ...
            {field: 'createTime', align: "center", sort: true, title: '创建时间', minWidth: 100},
    ...
    table.on('tool(' + MgrUser.tableId + ')', function (obj) {
        ...
        }else if (layEvent === 'areaAssign') {
            MgrUser.areaAssign(data);
        }
     ...
     * @param
     */
    MgrUser.areaAssign = function (data) {
            var index = layer.open({
                ...
                fix: false, //不固定
                maxmin: true,
                content: Feng.ctxPath + '/mgr/area_assign/' + data.userId,
                end: function () {
                    table.reload(MgrUser.tableId);
                }
            });
