...
import static cn.stylefeng.guns.base.auth.constants.SsoConstants.LOGIN_USER_SESSION;
...
public class AuthKit {
    ...
    public static LoginUser getUser() {
        return (LoginUser) HttpKit.getRequest().getAttribute(LOGIN_USER_SESSION);
    }
    ...
    public static boolean isAdmin() {
        List<Long> roleList = AuthKit.getUser().getRoleList();
        for (Long integer : roleList) {
            String singleRoleTip = ConstantFactory.me().getSingleRoleTip(integer.intValue());
